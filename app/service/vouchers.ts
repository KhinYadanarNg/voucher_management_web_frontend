export const redeemCampaignsClaimVouchers = async (
  ...
  try {
    const res = await fetch(
      `${process.env.backendAPIURL}/api/voucher/claim`,
      {
        method: "POST",
        headers: {
...
export const fetchVouchersByCustomerEmail = async (useremail: string) => {
  ...
  const res = await fetch(
    `${process.env.backendAPIURL}/api/voucher/getByEmail`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export const consumeVoucherByCustomer = async (voucherId: string) => {
  ...
  try {
    const res = await fetch(
      `${process.env.backendAPIURL}/api/voucher/consume`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchVouchersByCampaignId = async (campaignId: string) => {
  ...
  const res = await fetch(
    `${process.env.backendAPIURL}/api/voucher/getByCampaignId/${campaignId}`
  )
